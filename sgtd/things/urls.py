...
urlpatterns = patterns('',
    ...
    url(r'^stuff/(?P<pk>\d+)/not-actionable/$', views.ThingDeleteView.as_view(success_url='is_actionable'), name='not_actionable'),
    ...
    url(r'^action/(?P<pk>\d+)/delete/$', views.ThingDeleteView.as_view(success_url='next_action'), name='action_delete'),
